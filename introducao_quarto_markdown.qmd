...
6.  Mudança de chunks do R Markdown para chunks com \|#

    ```{r, echo = FALSE, eval = FALSE, out.width = "50%", fig.align = 'center', fig.cap = "Um gatinho."}

    knitr::include_graphics("cat.png")

    ## Para conventer os argumentos de chunk de todo documento do formato R Markdown para Quarto podemos usar:
