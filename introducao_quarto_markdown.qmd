...
Nesse arquivo .yml você ecnontrará essas principais estruturas de configuração:

1.  **Project**: indicação do tipo de projeto, no caso, website;

2.  **Website**: Configurações do site, como título, abas, conteúdo presente em cada aba (arquivos .qmd), localização das abas no lado esquerdo ou direito, etc;

3.  **Format**: tipo de arquivo (HTML), o tema para estética do site, a indicação do arquivo css, entre outros estilos;
