...
Os diagramas abaixo mostram o processo de criação de websites, as etapas iniciais e os arquivos presentes como o .yml e .qmd. Os diagramas acima foram formados com a linguagem [Mermaid](https://mermaid.js.org/) inserida no Quarto e é feito dentro de um chunk.
